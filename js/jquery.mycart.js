...
(function ($) {
  ...
  var loadMyCartEvent = function(targetSelector){
    ...
    var drawTable = function(){
      ...
      $.each(products, function(){
        ...
        $cartTable.append(
          ...
          '<td title="Quantity"><input type="number" min="1" style="width: 70px;" class="' + classProductQuantity + ' form-control input-sm" value="' + this.quantity + '"/></td>' +
          '<td title="Total" class="' + classProductTotal + '">'   + MathHelper.getRoundedNumber(total) + '</td>' +
          '<td title="Remove from Cart" class="text-center" style="width: 30px;"><a href="javascript:void(0);" class="btn btn-xs btn-danger ' + classProductRemove + '">X</a></td>' +
          '<td><input type="hidden" name="id_menu[]" value="' + this.id + '"><input type="hidden" name="qty[]" value="' + this.quantity + '"><input type="hidden" name="subtotal[]" value="' + MathHelper.getRoundedNumber(total) + '"></td>' +
          '</tr>'
        );
      });
      ...
      $cartTable.append(products.length ?
        ...
        '<td></td>' +
        '<td><input type="hidden" id="grandtotal" name="total"></td>' +
        '</tr>'
    ...
    var showGrandTotal = function(){
      ...
      $("#grandtotal").val(MathHelper.getRoundedNumber(ProductManager.getTotalPrice()));
    }
